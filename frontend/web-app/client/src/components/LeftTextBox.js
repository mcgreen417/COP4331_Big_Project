    ...
    <div className="left-text-box">
      ...
      <div className="scrollable">
        ...
        <div className="sub-text">
          ...
          automated reminders for important care tasks. Log important data about
          your plant such as its nickname, species, classification, water and
          sunglight requirements, and store custom notes.
        </div>
        <br />
        <div className="sub-text">
