        ...
        <View style = {{backgroundColor:'#4CB97A', marginTop:20}}>
                    ...
                    {flag == true && 
                        ...
                        <View style = {{flexDirection:'row', justifyContent:'flex-end', paddingRight:5,alignItems:'center'}}>
                            <TouchableOpacity style = {{flexDirection:'row', alignItems:'center'}} onPress = {() => alert("password changed")}>
...
function AboutDropdown()
{
    ...
    return(
        ...
        {flag == true && 
            <View style = {{flexWrap:'wrap', alignItems:'flex-start', height:150, justifyContent:'space-between'}}>
                <Text style = {{color:'white'}}>App created by Richard Gullo, Nolan Schafer, Michaela Green, Aden Carver,  Scott McLeod, Donald Poland, Hung Nguyen</Text>
                <Text style = {{color:'white'}}>Icons: Material Icons (Rounded)</Text>
                <Text style = {{color:'white'}}>Visit us on the web at flowerpower.io!</Text>
