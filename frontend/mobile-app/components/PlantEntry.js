        ...
        <View style={{ flexDirection: "row" }}>
          ...
          <View style={styles.plantDataContainer}>
            ...
            <View style={styles.plantInfoContainer}>
              <Text>
                <Text style={{ color: Color.darkGreen }}>Nickname:</Text>{" "}
                {props.nickname}
              </Text>
              <Text>
                <Text style={{ color: Color.darkGreen }}>Species:</Text>{" "}
                {props.species}
              </Text>
              <Text>
                <Text style={{ color: Color.darkGreen }}>Date Acquired: </Text>
                {props.date}
              </Text>
